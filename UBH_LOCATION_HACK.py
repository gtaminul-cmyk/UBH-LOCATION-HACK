...
# UBH Track Phone by UBH - FULL AUTO INSTALL + CLOUDFLARE
...
def tool_lock():
    ...
    print(f"{RED}║{'UBH TRACK PHONE BY DarkRoot'.center(60)}║{RESET}")
    print(f"{RED}║{'Subscribe @ummahblackhat 🔔'.center(60)}║{RESET}")
    print(f"{RED}╚{'═'*60}╝{RESET}\n")
    ...
    os.system('am start -a android.intent.action.VIEW -d "https://youtube.com/@ummahblackhat?si=iLFXU-xyXgINiA54" > /dev/null 2>&1 || true')
...
def main():
    ...
    os.system("clear")
    print(f"{GREEN}🚀 Starting UBH Track Phone...{RESET}")
